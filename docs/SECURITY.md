...
Роли: MODERATOR (модератор сайта), CHIEF_DOCTOR, ORTHOPEDIC_MANAGER, SURGEON, ORTHOPEDIST, CONSULTING_DOCTOR, DENTAL_TECHNICIAN, ASSISTANT, RADIOLOGY_OPERATOR, AUDITOR.
