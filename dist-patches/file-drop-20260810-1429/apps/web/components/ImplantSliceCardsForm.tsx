  ...
  return (
    <section className="card mb-6">
      ...
      <p className="mb-4 text-sm text-gray-600">
        Выберите челюсть и загрузите JPG-срезы в окна зубов (кнопка «Выберите файл» или перетащите
        файл на окно зуба). Пустые окна допустимы. Вид и метод установки на этом этапе необязательны.
      </p>
