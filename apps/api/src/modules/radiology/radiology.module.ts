...
export class RadiologyController {
  ...
  async create(@Body() dto: CreateRadiologyDto, @CurrentUser() user: AuthUser) {
    await this.stageAccess.assertCanMutateStage(dto.stageInstanceId, user);
...
@Module({
  controllers: [RadiologyController, StageRadiologyController],
