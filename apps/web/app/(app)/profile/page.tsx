  ...
  return (
    <div>
      <PageHeader
        ...
        description="После подтверждения модератором можно изменить ФИО, телефон, почту, пароль и цвет логотипа аккаунта. Должность, специализацию и роли правит только модератор."
      />

      {user.accountStatus === 'PENDING' ? (
        <div className="alert-error mb-4 bg-accent-light text-graphite">
          Заявка на права сотрудника ожидает подтверждения модератором. Сейчас доступен только
      ...
      <form onSubmit={handleSubmit} className="card max-w-xl space-y-4">
        ...
        <div>
          <label className="label-field">Права доступа в системе</label>
